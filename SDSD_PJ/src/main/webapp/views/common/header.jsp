...
<head>
    ...
    <link rel="stylesheet" href="${ path }/resources/css/sdsd_faq.css?v0.0.5" type="text/css">
    ...
    <link rel="stylesheet" href="${ path }/resources/css/sdsd_club.css?v0.1.02" type="text/css">
