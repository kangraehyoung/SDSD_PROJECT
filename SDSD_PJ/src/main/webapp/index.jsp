...
<section class="titleSection">
        <div class="mt1">
            <div class="mainIcon">
                ...
                <div class="mi_img">
                    ...
                    <a href="${ path }/views/ploboard/findClub.jsp"><img class="mi_img_2" src="${ path }/resources/imgFile/지구아이콘2.png" alt="plogging icon"></a>
                </div>
                <div class="mi_coment">
    ...
    <section class="mainSection_01">
        <div class="ms1">
            ...
            <div class="ms1_img">
                <div class="msi_1">
                    <img src="https://emojipedia-us.s3.amazonaws.com/source/skype/289/blossom_1f33c.png" alt="">
                </div>
            </div>
        </div>
    </section>
